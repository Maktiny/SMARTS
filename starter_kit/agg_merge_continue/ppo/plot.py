...
def plotimg(exposide,reward):
    ...
    plt.grid(True)
    plt.savefig("/home/carserver2/SMARTS/multi_merge/temp/data/2021-07-02-13-51-36/"+"reward.jpg")
    plt.show()

if __name__=="__main__":
    path = "/home/carserver2/SMARTS/multi_merge/temp/data/2021-07-02-13-51-36/log.txt"
