...
agent_missions = [
<<<<<<< HEAD
    Mission(Route(begin=("edge-west-WE", 0, 50), end=("edge-south-NS", (0,), 40))),
    Mission(Route(begin=("edge-west-WE", 0, 80), end=("edge-south-NS", (0,), 40))),
    Mission(Route(begin=("edge-west-WE", 0, 70), end=("edge-west-WE", (0,), 25))),
    Mission(Route(begin=("edge-west-WE", 0, 60), end=("edge-west-WE", (0,), 25))),
    Mission(Route(begin=("edge-south-SN", 0, 80), end=("edge-west-EW", (0,), 50))),
    Mission(Route(begin=("edge-south-SN", 0, 50), end=("edge-west-EW", (0,), 50))),
=======
